...
class VFB_Pro_Scripts_Loader {
	...
	public function add_js() {
		...
		wp_register_script( 'ion-range-slider', VFB_PLUGIN_URL . "public/assets/js/vendors/ion.rangeSlider.min.js", array( 'jquery' ), '2.2.0', true );
		...
		wp_register_script( 'vfb-steps', VFB_PLUGIN_URL . "public/assets/js/vendors/page-break.min.js", array( 'jquery' ), '1.1.4', true );
